...
namespace SalesWeb.Data
{
    ...
    {
        private SalesWebContext _content;

        public SeedingService(SalesWebContext content)
        {
            _content = content;
        }
        ...
        public void Seed()
        {
            if (_content.Department.Any() ||
                _content.Seller.Any() ||
                _content.SalesRecord.Any()
                )
            {
            ...
            _content.Department.AddRange(d1, d2, d3, d4);

            _content.Seller.AddRange(s1, s2, s3, s4, s5, s6);

            _content.SalesRecord.AddRange(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10,
